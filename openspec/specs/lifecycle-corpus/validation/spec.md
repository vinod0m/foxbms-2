...
The corpus SHALL provide a documented CLI at `tools/corpus.py` (or equivalent) supporting: inventory, validate, coverage, trace, impact, render, export, scenario-test, and check functions.
